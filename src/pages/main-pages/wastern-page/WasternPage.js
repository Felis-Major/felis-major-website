		...
		/> */}
			...
			<CenteredContentContainer direction="column">
				...
				>
					...
					<PageText>
						Rendez service au plus grand nombre d'esprits possible, agrandissez
						votre auberge, débloquez de nouveaux services sur votre terrain, il
						y a de quoi faire pour attirer le plus de client·es et de
						nouveaux·velles habitant·es à Wastern !
					</PageText>
				</HorizontalCard>
				<HorizontalCard
					imageSrc="https://via.placeholder.com/250x250"
				...
				>
					...
					<PageText>
						...
						club abandonné pour trouver des cristaux ? C'est vous qui choisissez
						!
					</PageText>
				</HorizontalCard>
				<HorizontalCard
				...
				>
					...
					<PageText>
						...
						sortes de plantes, animaux, objets et ambiances différentes. Si vous
						regardez attentivement, vous pourriez même trouver des passages
						secrets à débloquer au fil du temps…
					</PageText>
				</HorizontalCard>
				<HorizontalCard
					imageSrc="https://via.placeholder.com/250x250"
				...
				<HorizontalCard
					...
					direction="align-left"
				>
					<PageTitle size="small">Créez des liens avec les résidents</PageTitle>
					<PageText>
						Développez des relations romantiques ou amicales avec les [X]
						résident·es de Wastern, mais encore faut-il qu'iels viennent
						s'installer ici, il faudra redorer la réputation de la ville pour ça
						!
					</PageText>
				</HorizontalCard>
